...
**Audience:** People who love nature and animals — visitors who come for the imagery and atmosphere, not technical content.

## Tech Stack

- Plain HTML and CSS only — no frameworks, no JavaScript libraries, no preprocessors
- Single HTML file + single CSS file structure
...
- Let the photography lead — the UI should recede, not compete
